import { LogOut, RoowLeft, User,OcrIcon, PlusCirc, PlusSeg,PlusOcr,UserPlus }                                                       from '../../view/iconosSvg.jsx'
                ...
                <TouchableWithoutFeedback onPress={()=>{}}>
                    <View style={StyleAside.aside}>
                        ...
                        <View style={StyleAside.bodyAside}>
                            ...
                            <TouchableOpacity style={StyleAside.fieldOptionContainer} onPress={handlerSetSegProducts}>
                                <View style={StyleAside.iconOptionContainer}>
                                    <PlusSeg/>
                                </View>
                                <View style={StyleAside.contentOptionContainer}>
