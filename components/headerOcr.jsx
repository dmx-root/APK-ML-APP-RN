        ...
        <View style={StyleInfoViewOCR.header}>
            <View style={StyleInfoViewOCR.rowField}> 
                ...
                <View style={StyleInfoViewOCR.rowContente}>
                    ...
                    <View style={StyleInfoViewOCR.fieldContainer}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.mdl_id}</Text>
                    </View>
                </View>
                <View style={StyleInfoViewOCR.rowContente}>
                    <View style={StyleInfoViewOCR.fieldContainer}>
                    ...
                    <View style={StyleInfoViewOCR.fieldContainer}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.ref}</Text>
                    </View>
                </View>
                <View style={StyleInfoViewOCR.rowContente}>
                    <View style={StyleInfoViewOCR.fieldContainer}>
                    ...
                    <View style={StyleInfoViewOCR.fieldContainer}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.color_label}</Text>
                    </View>
                </View>
            </View>
            <View style={StyleInfoViewOCR.rowField}>
                <View style={StyleInfoViewOCR.rowContente}>
                    ...
                    <View style={[StyleInfoViewOCR.fieldContainer,{width:'50%'}]}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.dete_creation.slice(0,10)}</Text>
                    </View>
                </View>
                <View style={StyleInfoViewOCR.rowContente}>
                    <View style={StyleInfoViewOCR.fieldContainer}>
                    ...
                    <View style={StyleInfoViewOCR.fieldContainer}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.register_by_id}</Text>
                    </View>
                </View>
                <View style={StyleInfoViewOCR.rowContente}>
                    <View style={StyleInfoViewOCR.fieldContainer}>
                    ...
                    <View style={StyleInfoViewOCR.fieldContainer}>
                        <Text style={StyleInfoViewOCR.fieldontent}>{ocrInfoInterfaz.op}</Text>
                    </View>
                </View>
