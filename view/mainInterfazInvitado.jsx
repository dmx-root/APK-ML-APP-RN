...
import { MenuIcon, RefreshIcon, SearchIcon}                             from './iconosSvg.jsx';
...
export function MainInterfazInvitado({navigation}){
    
    const {DNS,currentUser,userToken,loadingSigIn,setLoadingSigIn}= useMainContex();

    const {setAsideState,asideState} =useInvitadoContext();
