                ...
                <TouchableWithoutFeedback onPress={()=>{}}>
                    <View style={StyleInfoViewOP.window}>
                        ...
                        <View style={StyleInfoViewOP.root}>
                            {loading?<LoadingComponent message={'Cargando lista de OCR..'}/>:
                            ocrList.length===0?<EmptyInterfaz data={'No se ha ingresado información al detalle de la OP'}/>:
                            <FlatList style={StyleInfoViewOP.flatList} 
                            renderItem={item=><OcrSpeComponent data={item}/>} 
