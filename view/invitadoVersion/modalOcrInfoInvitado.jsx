...
export function ModalOcrInfo(){
    const {setModalOcrInfo,ocrInfoInterfaz}=useInvitadoContext();
    ...
    //             <Text style={{fontSize:height*0.02,color:'#888',marginBottom:'4%'}}>Cargando la información...</Text>
