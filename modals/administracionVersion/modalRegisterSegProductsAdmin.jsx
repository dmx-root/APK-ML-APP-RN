...
export function ModalRegisterSegProductsAdmin(){
   
    
    const {modalRegisterSegundas,setRegisterSegundas,segList,informationSegundas}=useAdminContext();
                    ...
                    <View style={StyleModalEdit.boxMesagge}>
                        ...
                        <View style={StyleModalEdit.fame}>
                            <View style={StyleModalEdit.frameColumna}>
                                ...
                                {ocrList.length===0?<EmptyInterfaz/>:ocrList.map(element=><OcrSegComponentAdmin key={element.ean_id} data={element} modulo={informationSegundas.modulo}/>)}
